...
class GiftsScreen4 extends StatefulWidget {
  const GiftsScreen4({super.key});

  @override
  State<GiftsScreen4> createState() => _GiftsScreen4State();
}

class _GiftsScreen4State extends State<GiftsScreen4> {
  @override
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Chocoloony Valentine Day Chocolate Gift Box with Best Friend Ever Watch for Girlfriend Paper Gift Box  (Red)',
                      style: TextStyle(
                        fontFamily: 'Poppins',
                        fontSize: 14,
                      ),
